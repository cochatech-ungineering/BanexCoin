...
class AppColors {
  ...
  static const Color surfaceHighlight = Color(0xFF252533); // Slightly lighter surface

  // Text
  static const Color textPrimary = Color(0xFFFFFFFF);
  static const Color textSecondary = Color(0xFF9E9EA7); // Muted text for subtitles
  
  // Accents
  static const Color primaryOrange = Color(0xFFFF7E40); // Main brand color
  static const Color primaryOrangeDark = Color(0xFFF26822);
  static const Color accentPurple = Color(0xFF6B48FF); // Used for the "Pronto" ribbon

  // Specific elements
  static const Color badgeBackground = Color(0xFF2C2C3E); // e.g., USDT badge background
